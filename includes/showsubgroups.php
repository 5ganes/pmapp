			            ...
			            <tbody>
							...
							if($submenu['linkType']=='Normal Group' or $submenu['linkType']=='Contents Page'){
								...
								{?>
									<tr>
					                    <td><?php echo $count++;?></td>
					                    <td><a href="<?php if($downRow['linkType']=='Normal Group' or $downRow['linkType']=='Contents Page') echo $downRow['urlname']; else echo $downRow['contents'];?>"><? if($lan=='en') echo $downRow['nameen']; else echo $downRow['name']; ?></a></td>
					                </tr>
								<?php }
							}?>
			            </tbody>
