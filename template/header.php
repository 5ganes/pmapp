...
<html>
	<head>
		...
		<title>
			...
			?>
			<?php if($lan=='en'){
                echo 'Prime Minister Agriculture Modernization Project - ';
                if($pageNameEn!=""){ echo $pageNameEn;}else if(isset($_GET['action'])){ echo $_GET['action'];}else{ echo "Home";}
            }
            else{
                echo 'प्रधानमन्त्री कृषि आधुनिकिकरण परियोजना - ';
        ...
        <!-- galleryslider -->
        <link rel="stylesheet" type="text/css" href="galleryslider/slider.css">
