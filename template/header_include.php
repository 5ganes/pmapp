          ...
          <h1 class="logo">
              ...
              <div class="col-md-8 center-text" style="line-height: 20px;margin-top: -1%;">
                  <?php if($lan=='en'){?>
                      ...
                      <h5>Ministry of Agricultural Development</h5>
                      <h4>Prime Minister Agriculture Modernization Project</h4>
                      <h3>Superzone (Vegetable),  Kaski, Pokhara</h3>
                  <?php }
                  else{?>
                      <h4>नेपाल सरकार</h4>
                      <h5>कृषि विकास मन्त्रालय</h5>
                      <h4>प्रधानमन्त्री कृषि आधुनिकिकरण परियोजना</h4>
                      <h3>परियोजना कार्यान्वयन इकाई, सुपर-जोन (तरकारी), कास्की, पोखरा</h3>
                  <?php }?>
  ...
  <div class="content container">
      ...
      <section>
          ...
          <section class="news panel  marquee-body">
              <div class="" style="background-color:#86b67d;"> 
